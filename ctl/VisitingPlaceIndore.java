 ...
 *
 */
@WebServlet(name="VisitingPlaceIndore",urlPatterns={"/VisitingPlaceIndore"})
public class VisitingPlaceIndore extends BaseCtl {
...
//		RoleModel role=new RoleModel();
	...
	if(OP_SIGN_IN.equalsIgnoreCase(op)){
		...
		log.debug("UserCtl Method doPost Ended");
			...
			return ORSView.VISITING_PLACE_INDORE_VIEW;
}
